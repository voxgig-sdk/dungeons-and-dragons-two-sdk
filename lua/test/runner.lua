...
function runner.env_override(m)
  local live = runner.getenv("DUNGEONSANDDRAGONSTWO_TEST_LIVE")
  local override = runner.getenv("DUNGEONSANDDRAGONSTWO_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("DUNGEONSANDDRAGONSTWO_TEST_EXPLAIN")
