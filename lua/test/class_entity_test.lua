...
describe("ClassEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set DUNGEONS_AND_DRAGONS_TWO_TEST_CLASS_ENTID JSON to run live")
      return
    end
...
function class_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("DUNGEONS_AND_DRAGONS_TWO_TEST_CLASS_ENTID")
