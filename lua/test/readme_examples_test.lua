...
local SDK_MODULE = "dungeons-and-dragons-two_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["class"] = { ["test01"] = { id = "test01" } }, ["feature"] = { ["test01"] = { id = "test01" } }, ["monster"] = { ["test01"] = { id = "test01" } }, ["spell"] = { ["test01"] = { id = "test01" } } } }'
