...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.DUNGEONS_AND_DRAGONS_TWO_TEST_LIVE ||
    'TRUE' === process.env.DUNGEONS_AND_DRAGONS_TWO_TEST_OVERRIDE
  ) {
  ...
  m.DUNGEONS_AND_DRAGONS_TWO_TEST_EXPLAIN = process.env.DUNGEONS_AND_DRAGONS_TWO_TEST_EXPLAIN || m.DUNGEONS_AND_DRAGONS_TWO_TEST_EXPLAIN
