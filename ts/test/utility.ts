...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.DUNGEONSANDDRAGONSTWO_TEST_LIVE ||
    'TRUE' === process.env.DUNGEONSANDDRAGONSTWO_TEST_OVERRIDE
  ) {
  ...
  m.DUNGEONSANDDRAGONSTWO_TEST_EXPLAIN = process.env.DUNGEONSANDDRAGONSTWO_TEST_EXPLAIN || m.DUNGEONSANDDRAGONSTWO_TEST_EXPLAIN
