...
describe('FeatureDirect', async () => {
  ...
  test('direct-load-feature', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-feature', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['DUNGEONS_AND_DRAGONS_TWO_TEST_FEATURE_ENTID']
