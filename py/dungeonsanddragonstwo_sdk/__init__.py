...
from dungeonsanddragonstwo_sdk.utility import register

# Load features
from dungeonsanddragonstwo_sdk.feature.base_feature import DungeonsAndDragonsTwoBaseFeature
from dungeonsanddragonstwo_sdk.features import _make_feature


class DungeonsAndDragonsTwoSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = DungeonsAndDragonsTwoUtility()
        self._utility = utility

        from dungeonsanddragonstwo_sdk.config import make_config
        config = make_config()
    ...
    def get_utility(self):
        return DungeonsAndDragonsTwoUtility.copy(self._utility)
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "DungeonsAndDragonsTwoSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("DungeonsAndDragonsTwoSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Class(self, data=None) -> "ClassEntity":
        ...
        from dungeonsanddragonstwo_sdk.entity.class_entity import ClassEntity
    ...
    def Feature(self, data=None) -> "FeatureEntity":
        ...
        from dungeonsanddragonstwo_sdk.entity.feature_entity import FeatureEntity
    ...
    def Monster(self, data=None) -> "MonsterEntity":
        ...
        from dungeonsanddragonstwo_sdk.entity.monster_entity import MonsterEntity
        return MonsterEntity(self, data)


    def Spell(self, data=None) -> "SpellEntity":
        """Entity factory: client.Spell().list() / client.Spell().load({"id": ...})."""
        from dungeonsanddragonstwo_sdk.entity.spell_entity import SpellEntity
