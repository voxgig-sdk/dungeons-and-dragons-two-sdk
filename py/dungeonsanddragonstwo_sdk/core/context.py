...
from dungeonsanddragonstwo_sdk.core.control import DungeonsAndDragonsTwoControl
...
from dungeonsanddragonstwo_sdk.core.helpers import get_ctx_prop, to_map
...
class DungeonsAndDragonsTwoContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = DungeonsAndDragonsTwoControl()
        ...
        if isinstance(sp, DungeonsAndDragonsTwoSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, DungeonsAndDragonsTwoResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, DungeonsAndDragonsTwoResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return DungeonsAndDragonsTwoOperation({})
        ...
        op = DungeonsAndDragonsTwoOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return DungeonsAndDragonsTwoError(code, msg, self)
