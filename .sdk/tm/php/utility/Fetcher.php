...
// DungeonsAndDragonsTwo SDK utility: fetcher

class DungeonsAndDragonsTwoFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; DungeonsAndDragonsTwoSDK/1.0)';
    ...
    public static function call(DungeonsAndDragonsTwoContext $ctx, string $fullurl, array $fetchdef): array
    {
