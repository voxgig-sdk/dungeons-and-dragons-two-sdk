...
// DungeonsAndDragonsTwo SDK rbac feature
...
class DungeonsAndDragonsTwoRbacFeature extends DungeonsAndDragonsTwoBaseFeature
{
    ...
    private function _required(DungeonsAndDragonsTwoContext $ctx): ?string
    {
    ...
    private function _reject(DungeonsAndDragonsTwoContext $ctx, string $required): void
    {
    ...
    private function _track(DungeonsAndDragonsTwoContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
