...
// DungeonsAndDragonsTwo SDK netsim feature
...
class DungeonsAndDragonsTwoNetsimFeature extends DungeonsAndDragonsTwoBaseFeature
{
    ...
    private function _simulate(DungeonsAndDragonsTwoContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(DungeonsAndDragonsTwoContext $ctx, array $applied): void
    {
        $client = $this->client;
