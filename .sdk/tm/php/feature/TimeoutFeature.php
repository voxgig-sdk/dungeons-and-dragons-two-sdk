...
// DungeonsAndDragonsTwo SDK timeout feature
...
class DungeonsAndDragonsTwoTimeoutFeature extends DungeonsAndDragonsTwoBaseFeature
{
    ...
    private function _with_timeout(DungeonsAndDragonsTwoContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(DungeonsAndDragonsTwoContext $_ctx, float $ms): void
    {
        $client = $this->client;
