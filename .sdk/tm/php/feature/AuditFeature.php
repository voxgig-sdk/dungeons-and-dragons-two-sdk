...
// DungeonsAndDragonsTwo SDK audit feature
...
class DungeonsAndDragonsTwoAuditFeature extends DungeonsAndDragonsTwoBaseFeature
{
    ...
    private function _emit(DungeonsAndDragonsTwoContext $ctx, string $outcome): void
    {
