...
// DungeonsAndDragonsTwo SDK proxy feature
...
class DungeonsAndDragonsTwoProxyFeature extends DungeonsAndDragonsTwoBaseFeature
{
    ...
    public function init(DungeonsAndDragonsTwoContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (DungeonsAndDragonsTwoContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
