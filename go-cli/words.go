...
func registerSDKWords(r *eng.Registry, client *sdk.DungeonsAndDragonsTwoSDK) {
...
func runOp(client *sdk.DungeonsAndDragonsTwoSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
