// Command DungeonsAndDragonsTwo-cli is a CLI + REPL for the DungeonsAndDragonsTwo SDK,
...
const prompt = "dungeons-and-dragons-two"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "class feature monster spell"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      DUNGEONS_AND_DRAGONS_TWO_APIKEY (api key), DUNGEONS_AND_DRAGONS_TWO_BASE (base url override)")
