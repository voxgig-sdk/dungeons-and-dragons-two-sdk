...
AQL-driven CLI and REPL for the DungeonsAndDragonsTwo SDK. Positional arguments are
...
```sh
go build -o dungeons-and-dragons-two-cli ./...
```
...
./dungeons-and-dragons-two-cli load 1 class
./dungeons-and-dragons-two-cli load '{id:1}' class
