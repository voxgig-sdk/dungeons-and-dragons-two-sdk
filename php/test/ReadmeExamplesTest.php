...
// DungeonsAndDragonsTwo SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (DungeonsAndDragonsTwoSDK::test)
...
{
    private const SDK_CLASS = 'DungeonsAndDragonsTwoSDK';
    ...
    private const SDK_BASE = 'dungeonsanddragonstwo_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../dungeonsanddragonstwo_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
