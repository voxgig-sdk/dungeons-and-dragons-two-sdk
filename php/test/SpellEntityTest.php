...
class SpellEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set DUNGEONSANDDRAGONSTWO_TEST_SPELL_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function spell_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("DUNGEONSANDDRAGONSTWO_TEST_SPELL_ENTID");
