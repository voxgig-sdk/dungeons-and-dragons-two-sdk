...
class MonsterEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set DUNGEONS_AND_DRAGONS_TWO_TEST_MONSTER_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function monster_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("DUNGEONS_AND_DRAGONS_TWO_TEST_MONSTER_ENTID");
