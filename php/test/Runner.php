...
class DungeonsAndDragonsTwoTestRunner
{
    ...
    {
        $live = self::getenv('DUNGEONSANDDRAGONSTWO_TEST_LIVE');
        $override = self::getenv('DUNGEONSANDDRAGONSTWO_TEST_OVERRIDE');
        ...
        $explain = self::getenv('DUNGEONSANDDRAGONSTWO_TEST_EXPLAIN');
