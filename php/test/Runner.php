...
class DungeonsAndDragonsTwoTestRunner
{
    ...
    {
        $live = self::getenv('DUNGEONS_AND_DRAGONS_TWO_TEST_LIVE');
        $override = self::getenv('DUNGEONS_AND_DRAGONS_TWO_TEST_OVERRIDE');
        ...
        $explain = self::getenv('DUNGEONS_AND_DRAGONS_TWO_TEST_EXPLAIN');
...
class_alias('DungeonsAndDragonsTwoTestRunner', 'Runner');
class_alias('DungeonsAndDragonsTwoHelpers', 'Helpers');
