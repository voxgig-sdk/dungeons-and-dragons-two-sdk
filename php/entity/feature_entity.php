...
// DungeonsAndDragonsTwo SDK Feature entity
...
class FeatureEntity
{
     ...
     *
     * @param FeatureLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed FeatureLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Feature|array The loaded Feature as an assoc-array at the
