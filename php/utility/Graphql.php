...
// DungeonsAndDragonsTwo SDK utility: graphql
//
...
class DungeonsAndDragonsTwoGraphql
{
    ...
    // equivalent.
    public static function body(DungeonsAndDragonsTwoContext $ctx): mixed
    {
    ...
    public static function errors(DungeonsAndDragonsTwoContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
