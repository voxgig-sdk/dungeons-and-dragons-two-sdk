...
// DungeonsAndDragonsTwo SDK debug feature
...
class DungeonsAndDragonsTwoDebugFeature extends DungeonsAndDragonsTwoBaseFeature
{
    ...
    private function _finish(DungeonsAndDragonsTwoContext $ctx, bool $ok): void
    {
