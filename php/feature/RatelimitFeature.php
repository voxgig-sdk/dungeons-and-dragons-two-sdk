...
// DungeonsAndDragonsTwo SDK ratelimit feature
...
class DungeonsAndDragonsTwoRatelimitFeature extends DungeonsAndDragonsTwoBaseFeature
{
    ...
    private function _acquire(DungeonsAndDragonsTwoContext $ctx): void
    {
    ...
    private function _track(DungeonsAndDragonsTwoContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
