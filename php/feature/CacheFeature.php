...
// DungeonsAndDragonsTwo SDK cache feature
...
class DungeonsAndDragonsTwoCacheFeature extends DungeonsAndDragonsTwoBaseFeature
{
    ...
    private function _through(DungeonsAndDragonsTwoContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
