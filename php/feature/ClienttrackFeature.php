...
// DungeonsAndDragonsTwo SDK clienttrack feature
...
class DungeonsAndDragonsTwoClienttrackFeature extends DungeonsAndDragonsTwoBaseFeature
{
    ...
    public function PostConstruct(DungeonsAndDragonsTwoContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'DungeonsAndDragonsTwo-SDK';
