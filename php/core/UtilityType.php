...
// DungeonsAndDragonsTwo SDK utility type

class DungeonsAndDragonsTwoUtility
{
    ...
    public static function copy(DungeonsAndDragonsTwoUtility $src): DungeonsAndDragonsTwoUtility
    {
        $u = new DungeonsAndDragonsTwoUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
