...
type DungeonsAndDragonsTwoSDK struct {
	Mode     string
...
func (sdk *DungeonsAndDragonsTwoSDK) OptionsMap() map[string]any {
...
func (sdk *DungeonsAndDragonsTwoSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *DungeonsAndDragonsTwoSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *DungeonsAndDragonsTwoSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *DungeonsAndDragonsTwoSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *DungeonsAndDragonsTwoSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *DungeonsAndDragonsTwoSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("DungeonsAndDragonsTwoSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *DungeonsAndDragonsTwoSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *DungeonsAndDragonsTwoSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("DungeonsAndDragonsTwoSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *DungeonsAndDragonsTwoSDK {
	...
	sdk := NewDungeonsAndDragonsTwoSDK(sdkopts)
	sdk.Mode = "test"
