...
The Golang SDK for the DungeonsAndDragonsTwo API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/dungeons-and-dragons-two-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/dungeons-and-dragons-two-sdk=../path/to/github.com/voxgig-sdk/dungeons-and-dragons-two-sdk
```
...
```go
    result, err := client.Class(nil).List(nil, nil)
    if err != nil {
        panic(err)
    }
...
```
github.com/voxgig-sdk/dungeons-and-dragons-two-sdk/
...
The root package (`github.com/voxgig-sdk/dungeons-and-dragons-two-sdk`) re-exports everything needed
