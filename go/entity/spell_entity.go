...
type SpellEntity struct {
	name    string
	client  *core.DungeonsAndDragonsTwoSDK
...
func NewSpellEntity(client *core.DungeonsAndDragonsTwoSDK, entopts map[string]any) *SpellEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SpellEntity) GetName() string { return e.name }
...
func (e *SpellEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SpellEntity) Deleted() bool {
	return e.deleted
}


func (e *SpellEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSpellEntity(e.client, opts)
}

func (e *SpellEntity) Data(args ...any) any {
...
func (e *SpellEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Spell; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SpellEntity) DataTyped(data ...Spell) Spell {
	if len(data) > 0 {
		return typedFrom[Spell](e.Data(asMap(data[0])))
	}
	return typedFrom[Spell](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Spell (all fields
// optional at the wire level).
func (e *SpellEntity) MatchTyped(match ...Spell) Spell {
	if len(match) > 0 {
		return typedFrom[Spell](e.Match(asMap(match[0])))
	}
	return typedFrom[Spell](e.Match())
}
...
func (e *SpellEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SpellEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SpellLoadMatch and returns an Spell. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *SpellEntity) LoadTyped(reqmatch SpellLoadMatch, ctrl map[string]any) (Spell, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Spell{}, err
	}
	return typedFrom[Spell](res), nil
}




func (e *SpellEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// SpellListMatch and returns []Spell. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *SpellEntity) ListTyped(reqmatch SpellListMatch, ctrl map[string]any) ([]Spell, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Spell](res), nil
}



func (e *SpellEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SpellEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SpellEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SpellEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
