...
func envOverride(m map[string]any) map[string]any {
	if os.Getenv("DUNGEONSANDDRAGONSTWO_TEST_LIVE") == "TRUE" ||
		os.Getenv("DUNGEONSANDDRAGONSTWO_TEST_OVERRIDE") == "TRUE" {
		for key := range m {
	...
	if explain := os.Getenv("DUNGEONSANDDRAGONSTWO_TEST_EXPLAIN"); explain != "" {
