...
const testSeed = `map[string]any{"entity": map[string]any{"class": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "feature": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "monster": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "spell": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
