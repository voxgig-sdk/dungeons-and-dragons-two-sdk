...
class FeatureEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set DUNGEONSANDDRAGONSTWO_TEST_FEATURE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def feature_basic_setup(extra)
  ...
  entid_env_raw = ENV["DUNGEONSANDDRAGONSTWO_TEST_FEATURE_ENTID"]
