...
class MonsterEntityTest < Minitest::Test
  ...
  def test_stream
    ...
    base = DungeonsAndDragonsTwoSDK.test(seed, nil)
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set DUNGEONS_AND_DRAGONS_TWO_TEST_MONSTER_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def monster_basic_setup(extra)
  ...
  entid_env_raw = ENV["DUNGEONS_AND_DRAGONS_TWO_TEST_MONSTER_ENTID"]
  ...
  idmap_resolved = Helpers.to_map(
    env["DUNGEONS_AND_DRAGONS_TWO_TEST_MONSTER_ENTID"])
