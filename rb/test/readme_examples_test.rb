...
#      offline in seeded test mode (DungeonsAndDragonsTwoSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "DungeonsAndDragonsTwo_sdk.rb")
  SDK_CLASS = "DungeonsAndDragonsTwoSDK"
  ...
  SDK_BASE = "DungeonsAndDragonsTwo_sdk"
