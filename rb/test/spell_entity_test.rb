...
class SpellEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set DUNGEONS_AND_DRAGONS_TWO_TEST_SPELL_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def spell_basic_setup(extra)
  ...
  entid_env_raw = ENV["DUNGEONS_AND_DRAGONS_TWO_TEST_SPELL_ENTID"]
