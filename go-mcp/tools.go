...
type Args struct {
	Entity string         `json:"entity" jsonschema:"class | feature | monster | spell"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.DungeonsAndDragonsTwoSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "dungeons-and-dragons-two_list",
		Description: "List records from DungeonsAndDragonsTwo. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "dungeons-and-dragons-two_load",
		Description: "Load a single record from DungeonsAndDragonsTwo. " +
...
func runOp(client *sdk.DungeonsAndDragonsTwoSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.DungeonsAndDragonsTwoSDK, name string) (sdk.DungeonsAndDragonsTwoEntity, error) {
