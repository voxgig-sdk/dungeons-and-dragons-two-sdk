// Command DungeonsAndDragonsTwo-mcp is an MCP server exposing the DungeonsAndDragonsTwo
// SDK as MCP tools.
//
// Two tools are registered:
//
//	DungeonsAndDragonsTwo_list  — list records of an entity
//	DungeonsAndDragonsTwo_load  — load a single record of an entity
//
